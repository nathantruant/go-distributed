...
// RegisterService registers the given service
...
// ShutdownService gracefully removes the services from the registry
...
// ServeHTTP looks for post methods for updating the registry provider
